...
<template>
  <section>
    ...
    <NavigationButton v-if="currentQuestion !== questionAnswer.length" @click="() => handleNext(timer)"
      class="bg-blue-500 p-4 rounded-md mt-6 w-full xl:w-auto">Lanjut</NavigationButton>
